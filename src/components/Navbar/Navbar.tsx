    ...
    <Navbar expand="lg" className="mb-4 custom-navbar">
      ...
      <Navbar.Collapse id="basic-navbar-nav">
        <Nav className="me-auto navbar-links">
          <Nav.Link href="#about">I am ... </Nav.Link>
          <Nav.Link href="#experience">Technnically I do, </Nav.Link>
          <Nav.Link href="#extra-experience">Besides computing, I do;</Nav.Link>
          <Nav.Link href="#custom-projects">Projects</Nav.Link>
          <Nav.Link href="/classic/index.html"> More Curious?</Nav.Link>
